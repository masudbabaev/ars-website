const translations = {
  ...
  azizeh: {
    ...
    bio: {
      az: [
        "Azizeh Hosseinjany Sabancı Universitetinin Mühəndislik və Təbiət Elmləri fakültəsində və SUNUM-da postdoktoral tədqiqatçıdır. Hazırda TÜBİTAK-ın metal səthlər üçün ağıllı örtüklər layihəsində funksional örtüklər, səth mühəndisliyi, korroziyadan mühafizə və qabaqcıl metal materialları araşdırır.",
      ...
      en: [
        "Azizeh Hosseinjany is a postdoctoral researcher at the Faculty of Engineering and Natural Sciences and SUNUM at Sabancı University. Her current TÜBİTAK project on smart coatings for metal surfaces focuses on functional coatings, surface engineering, corrosion protection, and advanced metallic materials.",
